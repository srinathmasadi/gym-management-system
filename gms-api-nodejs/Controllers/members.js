...
exports.getAllMember = async(req,res)=>{
    try{
        ...
        res.status(200).json({
            message:members.length?"Fetched members successflly":"No Members",
...
exports.searchMember = async(req,res)=>{
    try{
        ...
        res.status(200).json({
            message:member.length?"Fetched members successfully":"No such members registered yet",
            members:member,
...
exports.inActiveMember = async(req,res)=>{
    try{
        const member = Member.find({gym:req.gym._id ,status:"Pending"});
        res.status(200).send({
...
exports.updateMemberPlan=async(req,res)=>{
    try{
        ...
        if(memberShip){
            ...
            await member.save();
            res.status(200).json({error:"Member Renewed Successfully"})
